...
void main() {
  BlurAppTestFramework.testGroup('BlurApp Widget Tests', () {
    BlurAppTestFramework.widgetTest('app renders without crashing', (
      tester,
    ) async {
    ...
    BlurAppTestFramework.widgetTest(
      'home screen is displayed as initial screen',
      (tester) async {
        await tester.pumpWidget(const BlurApp());
    ...
    BlurAppTestFramework.widgetTest('gallery and camera buttons are present', (
      tester,
    ) async {
      await tester.pumpWidget(const BlurApp());
