...
void main() {
  BlurAppTestFramework.testGroup(
    'BlurPipeline Core Algorithm Tests',
    () {
        ...
        () {
          ...
          for (int strength = 1; strength <= 30; strength++) {
            ...
            final result = BlurPipeline.applyBlur(
                testImageBytes, BlurType.gaussian, strength);
      ...
      BlurAppTestFramework.testCase(
        ...
        () {
          ...
          final result =
              BlurPipeline.applyBlur(testImageBytes, BlurType.pixelate, 10);
      ...
      BlurAppTestFramework.testCase(
        'mosaic effect produces valid output',
        () {
          final testImageBytes = TestHelpers.createTestImageBytes();

          final result =
              BlurPipeline.applyBlur(testImageBytes, BlurType.mosaic, 8);
      ...
      BlurAppTestFramework.testCase(
        'handles invalid blur type gracefully',
        () {
          final testImageBytes = TestHelpers.createTestImageBytes();
      ...
      BlurAppTestFramework.testCase(
        'handles edge case blur strength values',
        () {
          final testImageBytes = TestHelpers.createTestImageBytes();
          ...
          final result1 =
              BlurPipeline.applyBlur(testImageBytes, BlurType.gaussian, 0);
          expect(result1, isNotNull); // Current implementation returns data

          final result2 =
              BlurPipeline.applyBlur(testImageBytes, BlurType.gaussian, -1);
