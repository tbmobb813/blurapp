      ...
      group('[PERFORMANCE] Image Processing Memory Tests', () {
        BlurAppTestFramework.testCase(
          ...
          () {
            ...
            final gaussianResult =
                BlurPipeline.applyBlur(imageBytes, BlurType.gaussian, 5);
            final pixelateResult =
                BlurPipeline.applyBlur(imageBytes, BlurType.pixelate, 8);
            final mosaicResult =
        ...
        BlurAppTestFramework.testCase(
          'medium image processing performance',
          () {
            final imageBytes =
                createTestImage(width: 800, height: 600, complex: true);
      ...
      group('[PERFORMANCE] Edge Cases and Limits', () {
        BlurAppTestFramework.testCase(
          ...
          () {
            ...
            final result =
                BlurPipeline.applyBlur(tinyImageBytes, BlurType.gaussian, 1);
        ...
        BlurAppTestFramework.testCase(
          ...
          () {
            ...
            final result =
                BlurPipeline.applyBlur(invalidBytes, BlurType.gaussian, 5);
        ...
        BlurAppTestFramework.testCase(
          ...
          () {
            ...
            // Test extreme values
            final lowResult =
                BlurPipeline.applyBlur(imageBytes, BlurType.pixelate, -5);
            final highResult =
