  ...
  group('Phase 1: MediaPipe Foundation Tests', () {
    ...
    group('Hybrid Processing Pipeline', () {
      test('intelligent fallback to dart processing', () async {
        ...
        final result = await HybridBlurPipeline.processImage(testImageBytes, BlurType.gaussian, 10, preferNative: true);
        ...
        TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger.setMockMethodCallHandler(channel, (
          ...
          switch (methodCall.method) {
            ...
            case 'getProcessingCapabilities':
              return {'nativeAvailable': false, 'segmentationAvailable': false, 'gpu': false};
            default:
              return null;
          }
        });
